...
export async function registerRoutes(app: FastifyInstance) {
    ...
    app.get<{ Querystring: { interval?: 'week' | 'month'; points?: string; branchId?: string; officerId?: string; productId?: string } }>(
    ...
    app.get<{ Querystring: { customerId?: string; loanId?: string; agentId?: string; status?: any; actionType?: any; priority?: any; requiresApproval?: string; dateFrom?: string; dateTo?: string; page?: string; limit?: string } }>(
        '/api/collection-actions',
        {
            preHandler: [authenticate, requireBranch, authorize('ADMIN', 'MANAGER', 'OFFICER')],
        },
    ...
    app.post<{ Params: { id: string }; Body: { notes?: string; reason?: string } }>(
    ...
    app.get<{ Params: { customerId: string }; Querystring: { loanId?: string } }>(
    ...
    app.get<{ Querystring: { agentId?: string; dateFrom?: string; dateTo?: string } }>(
