...
interface DisbursementStatsCardsProps {
  stats: {
    pending: number;
    approved: number;
    disbursed: number;
...
export function DisbursementStatsCards({
  stats,
  isLoading,
}: DisbursementStatsCardsProps) {
  const cards = [
    {
      title: 'รออนุมัติ',
    ...
    {
      title: 'อนุมัติแล้ว',
      value: formatCompactNumber(stats.approved),
      unit: 'รายการ',
      icon: CheckCircle,
    ...
    {
      title: 'เบิกจ่ายแล้ว',
      value: formatCompactNumber(stats.disbursed),
      unit: 'รายการ',
      icon: Wallet,
    ...
    {
      title: 'ยอดเบิกจ่ายแล้ว',
      value: `฿${formatCompactNumber(stats.disbursedAmount)}`,
      unit: '',
      icon: DollarSign,
