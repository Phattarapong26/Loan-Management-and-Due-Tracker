  ...
  const cards = [
    {
      ...
      subtitle: criticalOverdueCount > 0 ? `NPL: ${criticalOverdueCount} รายการ` : totalOverdueAmount > 0 ? formatCurrency(totalOverdueAmount) : undefined,
      isLoading,
    ...
    },
    {
      ...
      subtitle: dueSoonCount > 0 ? `ด่วน (1-7 วัน): ${dueSoonCount}` : totalAmountDue > 0 ? formatCurrency(totalAmountDue) : undefined,
      isLoading,
      waveDirection: 'right' as const
    },
    {
      title: 'ครบกำหนดวันนี้',
      value: formatCompactNumber(todayCount),
      unit: 'รายการ',
      icon: Calendar,
    ...
    {
      title: 'สัญญาชำระ',
      value: formatCompactNumber(promisedCount),
      unit: 'รายการ',
      icon: CheckCircle,
